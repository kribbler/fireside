...
global 	$THEMEREX_mainmenu_left, $THEMEREX_mainmenu_right, $THEMEREX_mainmenu_mobile,
		$logo_image;
...
<div id="wrapBox" class="wrapBox">
	...
	<header id="header">
		<div class="wrapWide media_kit"><?php dynamic_sidebar( 'get-the-media-kit' ); ?></div>
		<div class="sc_columns_3">
			<div class="sc_columns_item">
				<div class="wrapTopMenu">
					<div class="topMenu">
						<?php echo balanceTags($THEMEREX_mainmenu_left); ?>
					</div>
				</div>
			</div>
			...
			<div class="sc_columns_item">
				...
				<?php if ( get_custom_option('main_menu_show') == 'yes' && $THEMEREX_mainmenu_left && $THEMEREX_mainmenu_right)  { ?>
			...
			<div class="sc_columns_item">
				<div class="wrapTopMenu">
					<div class="topMenu">
						<?php echo balanceTags($THEMEREX_mainmenu_right); ?>
					</div>
				</div>
			</div>

...
global $logo_footer, $THEMEREX_footer_menu; 
	...
	<footer <?php echo 'class="footer"' ?>>
		<div class="sc_columns_4 footer_top">
			<div class="wrapWide">
				<div class="sc_columns_item">
					<?php dynamic_sidebar( 'footer-follow-us' ); ?>
				</div>
				<div class="sc_columns_item">
					<h2>Navigate</h2>
					<div class="textwidget">
						<?php echo balanceTags($THEMEREX_footer_menu); ?>
					</div>
				</div>
				<div class="sc_columns_item">
					<h2>Recent Posts</h2>
					<div class="textwidget">
						<?php echo get_recent_posts(); ?>
					</div>
				</div>
				<div class="sc_columns_item">

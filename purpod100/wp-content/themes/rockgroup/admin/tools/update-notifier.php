...
define( 'NOTIFIER_THEME_NAME', 'RockGroup' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'rockgroup' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', '' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier() {
    ...
    <div class="wrap">
        ...
        <div><img alt="" style="margin: 0 0 20px 0; border: 1px solid #ddd;" src="<?php echo get_template_directory_uri() . '/screenshot.png'; ?>" /></div>

			...
			if (scrollPosition > scrollSkills) {
					...
					$datasets.push(
						{
							...
							pointHighlightStroke: 'rgba('+Hex2RGB_1($currData.attr('data-fill-color')).red+','+Hex2RGB_1($currData.attr('data-fill-color')).green+','+Hex2RGB_1($currData.attr('data-fill-color')).blue+',1)',
							// Bar
							highlightFill    : 'rgba('+Hex2RGB_1($currData.attr('data-fill-color')).red+','+Hex2RGB_1($currData.attr('data-fill-color')).green+','+Hex2RGB_1($currData.attr('data-fill-color')).blue+',1)',
							highlightStroke  : 'rgba('+Hex2RGB_1($currData.attr('data-fill-color')).red+','+Hex2RGB_1($currData.attr('data-fill-color')).green+','+Hex2RGB_1($currData.attr('data-fill-color')).blue+',1)',
							// All
							label            : $currData.attr('data-fill-text'),
							fillColor        : 'rgba('+Hex2RGB_1($currData.attr('data-fill-color')).red+','+Hex2RGB_1($currData.attr('data-fill-color')).green+','+Hex2RGB_1($currData.attr('data-fill-color')).blue+',1)',
				...
				if($curr.hasClass('tw-animate'))
				{
					...
					setTimeout(function(){
						...
						$canvas.attr('width', $curr.width()+'px');
						$canvas.attr('height', 286); //graph height
